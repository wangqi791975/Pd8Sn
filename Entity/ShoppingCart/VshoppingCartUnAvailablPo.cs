...
{
    /// <summary>
    ///描述：购物车无效商品视图 ORM 映射类 
    /// </summary>
    [Class(Table = "v_shoppingcart_unavailable", Lazy = false, NameType = typeof(VshoppingCartUnAvailablPo), DynamicUpdate = true)]
    [Cache(Usage = CacheUsage.NonStrictReadWrite)]
    public class VshoppingCartUnAvailablPo
    {
        /// <summary>
        /// 自增ID
        /// </summary>
