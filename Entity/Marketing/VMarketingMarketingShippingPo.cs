...
namespace Com.Panduo.Entity.Marketing
{
    ...
    /// </summary>
    [Class(Table = "v_marketing_marketingshipping", Lazy = false, NameType = typeof(VMarketingMarketingShippingPo), DynamicUpdate = true)]
    [Cache(Usage = CacheUsage.NonStrictReadWrite)]
    public class VMarketingMarketingShippingPo
    {
        /// <summary>
        /// Id
        /// </summary>
