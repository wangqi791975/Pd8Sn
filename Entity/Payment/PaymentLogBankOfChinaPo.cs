...
{
    /// <summary>
    ///描述：BankOfChina支付日志表 ORM 映射类 
    ///创建人:罗海明
    ///创建时间：2015-03-03 13:54:17
    /// </summary>
    [Class(Table = "t_payment_log_bankofchina", Lazy = false, NameType = typeof(PaymentLogBankOfChinaPo), DynamicUpdate = true)]
    [Cache(Usage = CacheUsage.NonStrictReadWrite)]
    public class PaymentLogBankOfChinaPo
    {
        /// <summary>
        /// 主键,自增长
        /// </summary>
