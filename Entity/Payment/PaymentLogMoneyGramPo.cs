...
namespace Com.Panduo.Entity.Payment
{
    ...
    ///创建人:罗海明
    ///创建时间：2015-03-03 13:57:07
    /// </summary>
    [Class(Table = "t_payment_log_moneygram", Lazy = false, NameType = typeof(PaymentLogMoneyGramPo), DynamicUpdate = true)]
    [Cache(Usage = CacheUsage.NonStrictReadWrite)]
    public class PaymentLogMoneyGramPo
    {
        /// <summary>
        /// 主键,自增长
        /// </summary>
        ...
        /// 汇款人全名
        /// </summary>
        [Property(Column = "fullname_of_remitter")]
        public virtual string FullnameOfRemitter
        {
            get;
            set;
        }
