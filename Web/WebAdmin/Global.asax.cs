...
namespace Com.Panduo.Web
{
    public class MvcApplication : SpringMvcApplication
    {
        protected void Application_Start()
        {
            ...
            LoggerHelper.GetLogger(LoggerType.Admin).Info("系统已启动");
        }
        ...
        protected void Application_Error(object sender, EventArgs e)
        {
            ...
            sb.Append("堆栈信息:" + "\r\n" + error.StackTrace + "\r\n");
            //记录日志
            LoggerHelper.GetLogger(LoggerType.Admin).Error(sb, error);
        ...
        {
            LoggerHelper.GetLogger(LoggerType.Admin).Info("系统已停止运行");
        }
    }
}