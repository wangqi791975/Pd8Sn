    ...
    Set: function (resize, side) {
        ...
        if (oThis.Scale) {
            switch (side.toLowerCase()) {
                case "up":
                    _fun = function (e) {  oThis.scaleUpRight(e); };
                    _cursor = "n-resize";
                    break;
                case "down":
                    _fun = function (e) { oThis.scaleDownRight(e); };
                    _cursor = "n-resize";
                    break;
                case "left":
                    _fun = function (e) { oThis.scaleLeftUp(e);  };
                    _cursor = "e-resize";
                    break;
                case "right":
                    _fun = function (e) {  oThis.scaleRightDown(e);  };
                    _cursor = "e-resize";
                    break;
                case "left-up":
                    _fun = function (e) { oThis.scaleLeftUp(e); };
                    ...
                    break;
                case "right-up":
                    _fun = function (e) { oThis.scaleRightUp(e); };
                    _cursor = "ne-resize";
                    break;
                case "left-down":
                    _fun = function (e) {  oThis.scaleLeftDown(e);  };
                    _cursor = "ne-resize";
                    break;
                case "right-down":
                default:
            ...
            switch (side.toLowerCase()) {
                case "up":
                    _fun = function (e) {  oThis.SetUp(e);  };
                    _cursor = "n-resize";
                    break;
                case "down":
                    _fun = function (e) {  oThis.SetDown(e);  };
                    _cursor = "n-resize";
                    break;
                case "left":
                    _fun = function (e) {  oThis.SetLeft(e);  };
                    _cursor = "e-resize";
                    break;
                case "right":
                    _fun = function (e) {  oThis.SetRight(e);  };
                    _cursor = "e-resize";
                    break;
                case "left-up":
                    _fun = function (e) { oThis.SetLeft(e); oThis.SetUp(e);  };
                    _cursor = "nw-resize";
                    break;
                case "right-up":
                    _fun = function (e) {  oThis.SetRight(e); oThis.SetUp(e);  };
                    _cursor = "ne-resize";
                    break;
                case "left-down":
                    _fun = function (e) {  oThis.SetLeft(e); oThis.SetDown(e);  };
                    _cursor = "ne-resize";
                    break;
                case "right-down":
                default:
                    _fun = function (e) {  oThis.SetRight(e); oThis.SetDown(e);  };
                    _cursor = "nw-resize";
            }
        }
